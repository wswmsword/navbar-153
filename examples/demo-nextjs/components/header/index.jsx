...
import { NavBar, Trigger, Content, Item, CustomXMotionContent, ReducedMotionContent } from "navbar-153";
...
export default function Header({ lng }) {
  ...
  const FinalC = !motion ? ReducedMotionContent : customTrans ? CustomXMotionContent : Content;
  const customTransProps = customTrans && motion ? {
